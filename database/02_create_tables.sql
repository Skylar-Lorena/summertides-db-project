-- This script creates the core festival tables and defines the relationships between them.
-- Each table includes primary keys, foreign keys, and constraints that reflect the business rules of the system.
...
CREATE TABLE stage_sponsors (
    ...
    sponsorship_level TEXT NOT NULL DEFAULT 'Platinum',
